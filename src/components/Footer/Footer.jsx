    ...
    <footer className="footer">
      <div className="footer-content">
        <div className="col">
          ...
          <div className="text">
            Voluptatem accusantium doloreque laudantium, totam rem aperiam,
        ...
        <div className="col">
          ...
          <div className="c-item">
            <FaMobileAlt />
            <div className="text">Phone: 0741 272 0261</div>
          </div>
          <div className="c-item">
            <FaEnvelope />
            <div className="text">Email: ryrahul123456@gamil.com</div>
          </div>
        </div>
        <div className="col">
